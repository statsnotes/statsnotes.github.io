...
In the last lesson, we discussed the OLS estimation processes. Today, we discuss the properties of our estimates, and how can we use them for statistical inference.
