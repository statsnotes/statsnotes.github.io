...
We want to show $E(\beta_1) = \beta_1$. Let us start off with the OLS estimator (which we derived in [1.4.4](https://statsnotes.github.io/theory/4.html#mathematics-of-the-ordinary-least-squares-estimator)):
...
1.  Add control variables with multiple linear regression (discussed in [lesson 1.6](https://statsnotes.github.io/theory/6.html) and 1.7)
