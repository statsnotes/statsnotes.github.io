...
In the last lesson, we discussed the estimation process of OLS for multiple linear regression. But we have to ask ourselves - is OLS a good estimator? Why should we use OLS? In this lesson, we focus on the properties of OLS, and the conditions under which OLS is a good estimator.
...
::: callout-warning
This lesson (especially the first half) will mirror the first half of [lesson 1.5](https://statsnotes.github.io/theory/5.html), but will adjust the properties of bivariate regression to multiple regression. I recommend a strong understanding of those topics before starting this chapter.
:::
...
-   For multiple regression, we will have $k+1$ moments for $\beta_0, \beta_1, \dots, \beta_k$
...
Which as we can see, are the exact same minimisation conditions as the method of moments estimator. Thus, the OLS estimator is a special case of the Method of Moments estimator.
...
# 1.7.7: OLS and the Conditional Expectation Function
