...
subtitle: "Lesson 1.9: Categorical Variables in Regression"
format:
    html:
        page-layout: article
        grid:
        ...
        toc-location: left
        toc-expand: true
        toc-title: "Lesson 1.9: Categorical Variables in Regression"
...
# 1.9.1: What are Categorical Variables
...
# 1.9.2: Binary Explanatory Variables in Regression
...
# 1.9.3: OLS as a Difference-in-means Estimator
