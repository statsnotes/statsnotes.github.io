...
-   We provided graphical examples of homoscedasticity in [1.5.4](https://statsnotes.github.io/theory/5.html#variance-of-the-ols-estimator-and-homoscedasticity).
...
$$
\widehat{Var}(\hat\beta_1) = \frac{\sum_{i=1}^n \widetilde{r_{1i}}^2 \sigma^2_i}{\sum_{i=1}^n\widetilde{r_{1i}}^2}
$$
...
$$
\widehat{se}(\hat\beta_j) = \sqrt{\frac{\sum_{i=1}^n \widetilde{r_{ji}}^2 \sigma^2_i}{\sum_{i=1}^n\widetilde{r_{ji}}^2}}
$$
:::
...
-   If you do not know what a moment is, see 1.7.7.

<br />

OLS is also a consistent estimator.
