...
-   If you are interested in non-statistics quantitative methods, see [Game Theory for Social Scientists](https://statsnotes.github.io/games).

The guide is divided into parts, with each part containing lessons. The guide covers a variety of topics, including statistical theory, causal inference, multivariate statistics, spatial and time-series data, and statistical learning.

You do not have to undertake the parts in order, except that *Part I* is a prerequisite for subsequent parts. Each lesson provides R-code for implementation purposes.
