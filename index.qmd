...
The guide covers a variety of topics, including statistical theory, causal inference, multivariate statistics, spatial econometrics, and time-series analysis.
...
*This part starts by introducing the basics of statistical theory. Then, we discuss the generalised linear model - the family of regression models form the basis of much of statistics.*
...
-   [1.6: Categorical Explanatory Variables](https://statsnotes.github.io/intro/8.html)
-   [1.7: Interactions and Functional Form](https://statsnotes.github.io/intro/9.html)
-   1.8: Logistic Regression Model
-   1.9: Ordinal and Multinomial Logistic Models
...
-   [2.3: Unbiasedness of the OLS Estimator](https://statsnotes.github.io/metrics/3.html)
-   [2.4: Variance of the OLS Estimator](https://statsnotes.github.io/metrics/4.html)
-   2.5: Method of Moments Estimator
-   2.6: Instrumental Variables Estimator
-   2.7: The Maximum Likelihood Estimator
...
-   3.1: Introduction to Multivariate Statistics
-   3.2: Principle Components Analysis
-   3.3: Exploratory Factor Analysis
-   3.4: Confirmatory Factor Analysis
-   3.5: Latent Traits and Item Response Theory
-   3.6: Latent Class Models
-   3.7: Cluster Analysis
-   3.8: Structural Equation Modelling
-   3.9: Extensions to Structural Equation Modelling
...
-   5.8: Machine Learning for Spatial Analysis
