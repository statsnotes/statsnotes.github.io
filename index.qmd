...
*This part introduces basic statistical theory, the generalised linear model (GLM), and the common estimators used in econometrics. This part serves as the basis of all following material.*
...
-   [1.8: Categorical Explanatory Variables](https://statsnotes.github.io/theory/8.html)
...
-   1.12: Ordinal and Multinomial Logistic Models
-   1.13: Poisson and Negative Binomial Models
-   1.14: Maximum Likelihood Estimator

<br />

## Part II: Applied Econometric Methods

*This part takes the theory introduced in Part I, and applies it to research designs and methods to identify and estimate causal effects.*
...
-   2.3: Regression and Selection on Observables
-   2.4: Matching and Weighting Estimators
-   2.5: Selection on Observables - Extensions
-   2.6: Differences-in-Differences
-   2.7: Fixed Effects Estimator
-   2.8: Modern Differences-in-Differences Estimators
-   2.9: Instrumental Variable Designs
-   2.10: Examiner, Shift-Share, and Recentered Instruments
-   2.11: Sharp Regression Discontinuity Designs
-   2.12 Fuzzy Regression Discontinuity and Kink Designs
-   2.13: Survey Experimental Designs
...
-   3.4: Latent Traits and Item Response Theory
...
## Part V: Spatial Econometric Methods
...
-   5.2: Descriptive Indicators of Spatial Clusters
...
-   6.5: Descriptive Statistics for Text Analysis
-   6.6: Automated Dictionary Methods
-   6.7: Machine Learning for Texts
-   6.8: Supervised Scaling Models for Texts
-   6.9: Unsupervised Models for Scaling Texts
-   6.10: Similarity and Clustering Methods
-   6.11: Structural Topic Models
